        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '3rem', marginBottom: '3rem' }}>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, m: 0, display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
              ...
              <li><Link to="/partners" style={{ color: 'var(--text-muted)', fontSize: '0.9rem', transition: 'color 0.2s', textDecoration: 'none' }} onMouseOver={e => e.target.style.color='var(--accent-blue)'} onMouseOut={e => e.target.style.color='var(--text-muted)'}>Partners Program</Link></li>
            </ul>
          </div>
